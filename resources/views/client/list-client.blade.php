<x-app-layout>
    ...
    <body>
        ...
        @endif
            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/update-client/{{ $client->id }}" class="btn btn-primary"><i class="bi bi-pencil-square"></i></a>
                            <button type="button" class="btn btn-danger delete-client-btn" data-bs-toggle="modal"
                                data-bs-target="#confirmDeleteModal" data-client-id="{{ $client->id }}">
            ...
            <!-- Add client button -->
            <a href="/add_client" class="btn btn-success"><i class="bi bi-plus"></i> Add Client</a>
        </div>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <a id="deleteClientBtn" class="btn btn-danger" href="#">Delete</a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                // Function to handle delete client button click
                $('.delete-client-btn').click(function() {
                    var clientId = $(this).data('client-id'); // Get the client ID from the button data attribute
                    ...
                    $('#deleteClientBtn').click(function() {
                        ...
                        $.ajax({
                            url: '/delete-client/' + clientId, // Replace '/delete-client/' with the actual delete route
                            type: 'DELETE',
                            headers: {
