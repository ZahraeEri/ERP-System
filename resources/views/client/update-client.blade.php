<x-app-layout>
    ...
    <div class="container mx-auto sm:px-4 mt-3">
        ...
        <form action="/update-client-treatment/{{ $client->id }}" method="post" enctype="multipart/form-data">
            @csrf
            <div class="row mb-3">
                <div class="col-md-6">
                    <label for="code" class="form-label">Code</label>
                    <input type="text" class="form-control" id="code" name="code" value="{{ $client->code }}" required>
                </div>
                <div class="col-md-6">
                    <label for="raison_sociale" class="form-label">Raison Sociale</label>
                    <input type="text" class="form-control" id="raison_sociale" name="raison_sociale" value="{{ $client->raison_sociale }}" required>
                </div>
            </div>
