<x-app-layout>
    ...
    <div class="container mx-auto sm:px-4 mt-3">
        ...
        <form action="/update-affaire-treatment/{{ $affaire->id }}" method="post" enctype="multipart/form-data"> @csrf
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Type_de_lot" name="Type_de_lot" required>
                        ...
                        @foreach ($typeDeLotOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Type_de_lot) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Mis_a_jour_par" name="Mis_a_jour_par" required>
                        ...
                        @foreach ($misAJourParOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Mis_a_jour_par) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Denomination" name="Denomination"
                        value="{{ $affaire->Denomination }}" required>
                </div>
                <!-- Retenue de garantie -->
                <div class="col-md-8">
                    ...
                    <select class="form-select" id="Retenue_de_garantie" name="Retenue_de_garantie" required>
                        ...
                        @foreach ($retenueDeGarantieOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Retenue_de_garantie) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Montant_Controle_plans_TTC"
                        name="Montant_Controle_plans_TTC" value="{{ $affaire->Montant_Controle_plans_TTC }}" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Montant_Controle_plans_HT"
                        name="Montant_Controle_plans_HT" value="{{ $affaire->Montant_Controle_plans_HT }}" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Montant_Controle_plans_TVA"
                        name="Montant_Controle_plans_TVA" value="{{ $affaire->Montant_Controle_plans_TVA }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <!-- Montant Controle des travaux TTC -->
                <div class="col-md-4">
                    <label for="Montant_Controle_travaux_TTC" class="form-label">Total Work Control Amount TTC</label>
                    <input type="text" class="form-control" id="Montant_Controle_travaux_TTC"
                        name="Montant_Controle_travaux_TTC" value="{{ $affaire->Montant_Controle_travaux_TTC }}"
                        required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Montant_Controle_travaux_HT"
                        name="Montant_Controle_travaux_HT" value="{{ $affaire->Montant_Controle_travaux_HT }}"
                        required>
                </div>
                <!-- Montant Controle des travaux TVA -->
                <div class="col-md-4">
                    <label for="Montant_Controle_travaux_TVA" class="form-label">Total Work Control Amount VAT</label>
                    <input type="text" class="form-control" id="Montant_Controle_travaux_TVA"
                        name="Montant_Controle_travaux_TVA" value="{{ $affaire->Montant_Controle_travaux_TVA }}"
                        required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Montant_RC_TTC" name="Montant_RC_TTC"
                        value="{{ $affaire->Montant_RC_TTC }}" required>
                </div>
                <!-- Montant RC HT -->
                <div class="col-md-4">
                    <label for="Montant_RC_HT" class="form-label">Total RC Amount(HT)</label>
                    <input type="text" class="form-control" id="Montant_RC_HT" name="Montant_RC_HT"
                        value="{{ $affaire->Montant_RC_HT }}" required>
                </div>
                <!-- Montant RC TVA -->
                <div class="col-md-4">
                    <label for="Montant_RC_TVA" class="form-label">RC VAT Amount</label>
                    <input type="text" class="form-control" id="Montant_RC_TVA" name="Montant_RC_TVA"
                        value="{{ $affaire->Montant_RC_TVA }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="Montant_HT" name="Montant_HT"
                        value="{{ $affaire->Montant_HT }}" required>
                </div>
                <!-- TVA -->
                <div class="col-md-3">
                    ...
                    <select class="form-select" id="TVA" name="TVA" required>
                        ...
                        @foreach ($tvaOptions as $id => $valeur)
                            <option value="{{ $id }}" @if ($id == $affaire->TVA) selected @endif>
                                {{ $valeur }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-3">
                    ...
                    <input type="text" class="form-control" id="Montant_TVA" name="Montant_TVA"
                        value="{{ $affaire->Montant_TVA }}" required>
                </div>
                <!-- Montant TTC -->
                <div class="col-md-3">
                    <label for="Montant_TTC" class="form-label">TTC Amount</label>
                    <input type="text" class="form-control" id="Montant_TTC" name="Montant_TTC"
                        value="{{ $affaire->Montant_TTC }}" required>
                </div>
            </div>
            <script>
                    ...
                    function getTVAValue(tvaId) {
                        $.ajax({
                            ...
                            success: function(response) {
                                $('#Montant_TVA').val(response
                                .montantTVA); // Update the TVA field with the returned value
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Client" name="Client" required>
                        ...
                        @foreach ($clients as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Client) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Maitre_doeuvre" name="Maitre_doeuvre"
                        value="{{ $affaire->Maitre_doeuvre }}" required>
                </div>
                <!-- B.E.T -->
                <div class="col-md-4">
                    <label for="BET" class="form-label">B.E.T</label>
                    <input type="text" class="form-control" id="BET" name="BET"
                        value="{{ $affaire->BET }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <!-- Tel_client -->
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Tel_client" name="Tel_client"
                        value="{{ $affaire->Tel_client }}" required>
                </div>
                <!-- Fax -->
                <div class="col-md-4">
                    <label for="Fax" class="form-label">Fax</label>
                    <input type="text" class="form-control" id="Fax" name="Fax"
                        value="{{ $affaire->Fax }}" required>
                </div>
                <div class="col-md-4">
                    ...
                    <input type="email" class="form-control" id="Email_client" name="Email_client"
                        value="{{ $affaire->Email_client }}" required>
                </div>
            </div>
            <div class="row mb-3">
                <!-- Adresse chantier -->
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Adresse_chantier" name="Adresse_chantier"
                        value="{{ $affaire->Adresse_chantier }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Responsable_projet" name="Responsable_projet"
                        value="{{ $affaire->Responsable_projet }}" required>
                </div>
                <!-- Tel_responsable -->
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Tel_responsable" name="Tel_responsable"
                        value="{{ $affaire->Tel_responsable }}" required>
                </div>
                <!-- Email_responsable -->
                <div class="col-md-4">
                    ...
                    <input type="email" class="form-control" id="Email_responsable" name="Email_responsable"
                        value="{{ $affaire->Email_responsable }}" required>
                </div>
            </div>
            <hr>
            <!-- Personne contacter -->
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Personne_contacter" name="Personne_contacter"
                        value="{{ $affaire->Personne_contacter }}" required>
                </div>
                <!-- Tel_personne -->
                <div class="col-md-4">
                    <label for="Tel_personne" class="form-label">Tel_person</label>
                    <input type="text" class="form-control" id="Tel_personne" name="Tel_personne"
                        value="{{ $affaire->Tel_personne }}" required>
                </div>
                <div class="col-md-4">
                    <label for="Fax_personne" class="form-label">Fax_person</label>
                    <input type="text" class="form-control" id="Fax_personne" name="Fax_personne"
                        value="{{ $affaire->Fax_personne }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="email" class="form-control" id="Email_personne" name="Email_personne"
                        value="{{ $affaire->Email_personne }}" required>
                </div>
            </div>
            ...
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Numero_du_devis" name="Numero_du_devis"
                        value="{{ $affaire->Numero_du_devis }}" required>
                </div>
                <!-- Type_commande -->
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Type_commande" name="Type_commande" required>
                        ...
                        @foreach ($typeDeCommandeOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Type_commande) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Numero_de_la_commande"
                        name="Numero_de_la_commande" value="{{ $affaire->Numero_de_la_commande }}" required>
                </div>
            </div>
            <!-- Date_de_la_commande -->
            <div class="row mb-3">
                <div class="col-md-4">
                    ...
                    <input type="date" class="form-control" id="Date_de_la_commande" name="Date_de_la_commande"
                        value="{{ $affaire->Date_de_la_commande }}" required>
                </div>
                <div class="col-md-4">
                    ...
                    <select class="form-select" id="Modalite_paiement" name="Modalite_paiement" required>
                        ...
                        @foreach ($modalitePaiementOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Modalite_paiement) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" class="form-control" id="Conditions_de_paiement"
                        name="Conditions_de_paiement" value="{{ $affaire->Conditions_de_paiement }}" required>
                </div>
            </div>
            <hr>
            <!-- Agence -->
            <div class="row mb-3">
                <div class="col-md-6">
                    ...
                    <select class="form-select" id="Agence" name="Agence" required>
                        ...
                        @foreach ($agenceOptions as $id => $libelle)
                            <option value="{{ $id }}" @if ($id == $affaire->Agence) selected @endif>
                                {{ $libelle }}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" class="form-control" id="Ingenieur_tecnitas" name="Ingenieur_tecnitas"
                        value="{{ $affaire->Ingenieur_tecnitas }}" required>
                </div>
            </div>
